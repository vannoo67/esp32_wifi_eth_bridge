...
var formSubmitted = qs.indexOf('ap_ip_addr=') !== -1 || (qs.indexOf('ssid=') !== -1 && qs.indexOf('password=') !== -1) || qs.indexOf('staticip=') !== -1 || qs.indexOf('reset=') !== -1 || qs.indexOf('disable_interface=') !== -1;\
if (formSubmitted) {\
...
<label style='margin-right: 0.8rem;'><input type='checkbox' name='rc_bind_ap' value='1' %s> ETH</label>\
...
<div id='otaBarFill' style='height:100%;width:0;background:#00e676;transition:width 0.3s;'></div>\
</div>\
</div>\
...
<p style='font-size:1.5rem;font-weight:bold;color:#00e676;' id='countdown'></p>\
...
/* Danger Zone section - uses %s for: web_bind_eth_chk, web_bind_sta_chk, web_bind_vpn_chk */
...
<label style='margin-right:0.8rem;color:#666;'><input type='checkbox' name='web_bind_eth' value='1' %s> ETH</label>\
